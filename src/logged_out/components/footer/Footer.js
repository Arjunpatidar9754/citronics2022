...
import collegeLogo1 from "../../images/collegeLogo1.png";
import collegeLogo2 from "../../images/collegeLogo2.png";
...
const infos = [
  {
    icon: <PhoneIcon />,
    description: "+91 73125 38874"
  },
  {
    icon: <MailIcon />,
    description: " citronics@cdgi.edu.in"
  }
];
      ...
      <div className={classes.footerInner}>
        <Grid container spacing={isWidthUp("md", width) ? 10 : 5}>
          ...
          <Grid item xs={12} md={6} lg={4}>
            ...
            <img src={collegeLogo1} alt="" className="footer-college-logo1" />
            <img src={collegeLogo2} alt="" className="footer-college-logo2" />
            <img src={collegeLogo3} alt="" className="footer-college-logo3" />
            <img src={collegeLogo4} alt="" className="footer-college-logo4" />
            <img src={Agrawal} alt="" className="footer-college-logo5" />

            <Typography style={{ color: "#8f9296" }} paragraph>
            Address : Umrikheda, Khandwa Road, Indore-452020 (M.P.)
            </Typography>
            <Box display="flex">
